...
- [미터링 배치 시스템 설계 응축: 쓰기 경합·청사진·패턴 명명·저장 전략 통일까지](https://blog.idean.me/posts/metering-batch-system-design/)
...
- [인증서 자동화 응축: 사용자 도메인 ACME4j 구현부터 와일드카드 Jenkins 갱신까지](https://blog.idean.me/posts/cert-automation-acme-and-wildcard/)
